...
<div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <h1 class="page-header"> <?php echo ADD_NEW_DOMAIN ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
  ...
  <div class="pull-right">
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu pull-right" role="menu">
                                        <li><a href="domains.php"><?php echo MANAGE_ALL_DOMAINS  ?></a>
                                        </li>
...
$message = $valid->RequiredData(array("domain_name" =>DOMAIN_NAME));
$message = $valid->IsValidDomainName(array("domain_name" =>DOMAIN_NAME));
...
$dbexist = $db->fetchOne("Select * from domains where domain_name=':domain_name'", array(":domain_name"=>$_POST['domain_name']));

if(empty($dbexist))
{
$file_handler = new DirFileHandler();

$domain_dir = "/var/www/html/". str_replace(".","_",$_POST['domain_name']);
...
array("fieldname" => "domain_name","fielddesc" =>DOMAIN_NAME,"fieldtype" => "text","fieldplaceholder" =>DOMAIN_NAME_PLACEHOLDER,"fieldvalue" =>"","data-required"=>"true","data-type"=>"","validator"=>"")
);
